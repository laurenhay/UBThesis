...
\begin{figure}[h!]
  ...
  \begin{subfigure}
      \centering
  \includegraphics[width=0.24\textwidth]{figures/multijet/dijet/eta_phi_2016.png}
    \end{subfigure}
    \begin{subfigure}
      \centering
      \includegraphics[width=0.24\textwidth]{figures/multijet/dijet/eta_phi_2016APV.png}
    \end{subfigure}
    \begin{subfigure}
      \centering
      \includegraphics[width=0.24\textwidth]{figures/multijet/dijet/eta_phi_2017.png}
    \end{subfigure}
    \begin{subfigure}
      \centering
      \includegraphics[width=0.24\textwidth]{figures/multijet/dijet/eta_phi_2018.png}
    \end{subfigure}
...
\end{equation}
THe resolution scale factor $\s_{\textrm{JER}}$ and their corresponding uncertainties are provided by the CMS collaboration.
